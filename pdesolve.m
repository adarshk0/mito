function pde_out = pdesolve(t_in, STATES, L, extra)
	...
	dPsi	= rshp(sol((1:uN)+6*uN));
	H_x		= rshp(sol((1:uN)+7*uN));
	NADH_x	= rshp(sol((1:uN)+8*uN));
	Pi_x	= rshp(sol((1:uN)+9*uN));
	QH2		= rshp(sol((1:uN)+10*uN));
	Cred	= rshp(sol((1:uN)+11*uN));
	O2		= rshp(sol((1:uN)+12*uN));
	K_x		= rshp(sol((1:uN)+13*uN));
	ATP_x	= rshp(sol((1:uN)+14*uN));
	ADP_x	= rshp(sol((1:uN)+15*uN));
